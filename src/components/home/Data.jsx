...
const Data = () => {
  return (
    <div className="home__data">
        <h1 className="home__title">HJ Miranda
            <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <h3 className="home__subtitle">Junior Programmer | Software Engineer</h3>
        <p className="home__description">I am passionate in developing websites and I value the importance of creating a project that will meet the client's needs.</p>
